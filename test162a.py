...
class Test162a:
    ...
    def __init__(self,config,app):
        ...
        self.msg = self.__config.get('tests','1.6.2a')
        self.msg_lan = self.__config.get('tests','1.6.2a')
    ...
    def set_flags(self):
        self.__config_setup1_1.set_flag_M(self.__config.get('t1.6.2a','flag_m'))
        self.__config_setup1_1.set_flag_0(self.__config.get('t1.6.2a','flag_o'))
        self.__config_setup1_1.set_flag_chlim(self.__config.get('t1.6.2a','flag_chlim'))
        self.__config_setup1_1.set_flag_L(self.__config.get('t1.6.2a','flag_l'))
        self.__config_setup1_1.set_flag_A(self.__config.get('t1.6.2a','flag_a'))
        self.__config_setup1_1.set_flag_R(self.__config.get('t1.6.2a','flag_r'))
        self.__config_setup1_1.set_flag_prf(self.__config.get('t1.6.2a','flag_prf'))

        self.__config_setup1_1.set_validlifetime(self.__config.get('t1.6.2a','validlifetime'))
        self.__config_setup1_1.set_preferredlifetime(self.__config.get('t1.6.2a','preferredlifetime'))
        self.__config_setup1_1.set_routerlifetime(self.__config.get('t1.6.2a','routerlifetime'))
        self.__config_setup1_1.set_intervalo(self.__config.get('t1.6.2a','intervalo'))
        self.__config_setup1_1.set_pd_prefixlen(self.__config.get('t1.6.2a','pd_prefixlen'))

        self.__config_setup1_1.set_prefix_addr(self.__config.get('setup1-1_advertise','ia_pd_address'))
        self.__config_setup1_1.set_dhcp_t1(self.__config.get('t1.6.2a','dhcp_t1'))
        self.__config_setup1_1.set_dhcp_t2(self.__config.get('t1.6.2a','dhcp_t2'))
        self.__config_setup1_1.set_dhcp_preflft(self.__config.get('t1.6.2a','dhcp_preflft'))
        self.__config_setup1_1.set_dhcp_validlft(self.__config.get('t1.6.2a','dhcp_validlft'))
        self.__config_setup1_1.set_dhcp_plen(self.__config.get('t1.6.2a','dhcp_plen'))
        self.__config_setup1_1.set_retranstimer(self.__config.get('t1.6.2a','retrans_time'))
        self.__config_setup1_1.set_reachabletime(self.__config.get('t1.6.2a','reach_time'))
    ...
    def run(self):
        ...
        self.__packet_sniffer_wan = PacketSniffer('test161',self.__queue_wan,self,self.__config,self.__wan_device_tr1)
        ...
        while not self.__queue_wan.full():
            ...
            wrpcap("wan-1.6.2a.cap",cache_wan)
            ...
            if not self.__config_setup1_1.get_setup1_1_OK():
                ...
                if not self.__config_setup1_1.get_disapproved():
                    ...
                    logging.info('WAN: Reprovado Teste 1.6.2a - Falha em completar o setup 1.1')
                    self.set_status('Reprovado Teste 1.6.2a - Falha em completar o setup 1.1')
                    time.sleep(2)
                    self.set_status('REPROVADO') # Mensagem padrão para o frontEnd atualizar Status
                    self.__packet_sniffer_wan.stop()
                    return False  
                ...
                if pkt.haslayer(ICMPv6EchoReply):
                    ...
                    if mac_dst == self.__config.get('wan','link_local_mac'):
                        ...
                        self.set_status('Aprovado Teste 1.6.2.a: Recebido Mensagem Echo Reply com MAC do CeRouter em MAC destino')
                        time.sleep(2)
                        ...
                        self.set_status('Reprovado Teste 1.6.2.a: Recebido Mensagem Echo Reply Sem MAC do CeRouter em MAC destino')
                        time.sleep(2)
                        self.set_status('REPROVADO') # Mensagem padrão para o frontEnd atualizar Status
                        return False  
