...
class Test275d:
    ...
    def __init__(self,config,app):
        ...
        self.msg = self.__config.get('tests','2.7.5d')
        self.msg_lan =self.__config.get('tests','2.7.5d')
        self.__config_setup_lan = ConfigSetup1_1_Lan(self.__config,self.__lan_device)



    def set_flags(self):
        self.__config_setup1_1.set_flag_M(self.__config.get('t2.7.5d','flag_m'))
        self.__config_setup1_1.set_flag_0(self.__config.get('t2.7.5d','flag_o'))
        self.__config_setup1_1.set_flag_chlim(self.__config.get('t2.7.5d','flag_chlim'))
        self.__config_setup1_1.set_flag_L(self.__config.get('t2.7.5d','flag_l'))
        self.__config_setup1_1.set_flag_A(self.__config.get('t2.7.5d','flag_a'))
        self.__config_setup1_1.set_flag_R(self.__config.get('t2.7.5d','flag_r'))
        self.__config_setup1_1.set_flag_prf(self.__config.get('t2.7.5d','flag_prf'))
        self.__config_setup1_1.set_validlifetime(self.__config.get('t2.7.5d','validlifetime'))
        self.__config_setup1_1.set_preferredlifetime(self.__config.get('t2.7.5d','preferredlifetime'))
        self.__config_setup1_1.set_routerlifetime(self.__config.get('t2.7.5d','routerlifetime'))
        ...
        self.__config_setup1_1.set_dhcp_t1(self.__config.get('t2.7.5d','dhcp_t1'))
        self.__config_setup1_1.set_dhcp_t2(self.__config.get('t2.7.5d','dhcp_t2'))
        self.__config_setup1_1.set_dhcp_preflft(self.__config.get('t2.7.5d','dhcp_preflft'))
        self.__config_setup1_1.set_dhcp_validlft(self.__config.get('t2.7.5d','dhcp_validlft'))
        self.__config_setup1_1.set_dhcp_plen(self.__config.get('t2.7.5d','dhcp_plen'))
    ...
    def run_Lan(self):
        ...
        while not self.__queue_lan.full():
            ...
            wrpcap("lan-2.7.5d.cap",cache_lan)
            ...
            if not self.__config_setup_lan.get_global_ping_OK():
                if not self.__config_setup_lan.get_disapproved():
                    ...
                    logging.info('LAN: Reprovado Teste 2.7.5d - Falha em completar o setup 1.1')
                    self.set_status_lan('Reprovado Teste 2.7.5d - Falha em completar o setup 1.1')
                    time.sleep(2)
                        ...
                        if pkt.haslayer(ICMPv6ND_RA):  
                            if pkt.haslayer(ICMPv6NDOptRouteInfo):
                                if pkt[ICMPv6NDOptRouteInfo].plen != 60:
                                    ...
                                    self.set_status_lan(' Teste2.7.5d: Reprovado. Tamanho do prefixo diferente do anunciado no DHCP Reconfigure')
                                    time.sleep(2)
                                    self.set_status_lan('REPROVADO') # Mensagem padrão para o frontEnd atualizar Status
                                    ...
                                    logging.info(' APROVADO Teste 2.7.5d:Tamanho do prefixo igual ao anunciado na mensagem DHCP Reconfigure.')

                                    self.set_status(' APROVADO Teste 2.7.5d:Tamanho do prefixo igual ao anunciado na mensagem DHCP Reconfigure.')
                                    time.sleep(2)
                                ...
                                logging.info(' Teste 2.7.5d: Reprovado. SEM ICMP Opt RouteInfo')
                                self.set_status_lan(' Teste2.7.5d: Reprovado. SEM ICMP Opt RouteInfo')
                                time.sleep(2)
                                self.set_status_lan('REPROVADO') # Mensagem padrão para o frontEnd atualizar Status
                                self.__packet_sniffer_lan.stop()
                                self.__finish_wan = True 
    ...
    def run(self):
        ...
        #time.sleep(11111)
        finish_wan = True
        self.__config_setup1_1.set_pd_prefixlen(self.__config.get('t2.7.5d','pd_prefixlen')) 
        self.__config_setup1_1.set_routerlifetime(self.__config.get('t2.7.5d','routerlifetime'))
        test_max_time = 300
        temporizador = 0 
        ...
        while not self.__queue_wan.full():
            ...
            wrpcap("WAN-2.7.5d.cap",cache_wan)
            ...
            if not self.__config_setup1_1.get_setup1_1_OK():
                ...
                if not self.__config_setup1_1.get_disapproved():
                    ...
                    logging.info('WAN: Reprovado Teste 2.7.6 - Falha em completar o setup 1.1')
                    self.set_status('WAN: Reprovado Teste 2.7.6 - Falha em completar o setup 1.1')
                    time.sleep(2)
