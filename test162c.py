        ...
        while not self.__queue_wan.full():
            ...
            if not self.__config_setup1_1.get_setup1_1_OK():
                ...
                if not self.__config_setup1_1.get_disapproved():
                    ...
                    logging.info('Reprovado Teste 1.6.2.c - Falha em completar o Common Setup 1.1 da RFC')
                    return False
                ...
                if pkt.haslayer(ICMPv6EchoReply):
                    ...
                    if mac_dst == self.__config.get('wan','ra_mac'):
                        self.__packet_sniffer_wan.stop()
                        logging.info('Aprovado Teste 1.6.2.c: Recebido Mensagem Echo Reply com endereço Global')
                        return True
                    else:
                        self.__packet_sniffer_wan.stop()
                        logging.info('Reprovado Teste 1.6.2.c: Recebido Mensagem Echo Reply Sem endereço Global')
                        return False
