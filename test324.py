                ...
                if t_test1 < 300:
                    ...
                    if pkt.haslayer(ICMPv6ND_RA):
                        ...
                        if pkt[ICMPv6NDOptPrefixInfo].prefix == self.__config.get('t3.2.4','prefix_ula'):
                            ...
                            logging.info('Teste 3.2.4 - FALHA. VERIFIQUE O PREFIXO ULA CONFIGURADO NA ULA DO ROTEADOR')
                        ...
                        if pkt.haslayer(ICMPv6DestUnreach):
                            self.__packet_sniffer_wan.stop() 
                            self.__packet_sniffer_lan.stop()
                            logging.info('Teste 3.7.2a - APROVADO. Não passou pacotes com prefixo ULA da LAN para WAN devido ao RouterLife time estar zerado')
                            return True   
                    ...
                    if not self.__finish_wan:
                        ...
                        if time1 < 300:
                            ...
                            if pkt.haslayer(ICMPv6EchoRequest):
                                ...
                                logging.info('Reprovado Teste 3.2.4 - Recebeu ICMPv6EchoRequest de um endereço ULA')
                                logging.info('Reprovado Teste 3.2.4 - Recebeu ICMPv6EchoRequest de um endereço ULA')
                                logging.info('Reprovado Teste 3.2.4 - Recebeu ICMPv6EchoRequest de um endereço ULA')
                                logging.info('Reprovado Teste 3.2.4 - Recebeu ICMPv6EchoRequest de um endereço ULA')
                                self.__packet_sniffer_wan.stop() 
